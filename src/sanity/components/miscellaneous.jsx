        ...
        <Stack>
          ...
          <Card style={{ paddingBottom: '3rem' }}>
            <Stack>
              ...
              {renderTextAreaField('miscDescription')}
            </Stack>
          </Card>
          ...
          <Grid columns={2} gap={1} style={{ alignItems: 'center' }}>
            ...
            <Card>{renderRateField('row1Price')}</Card>
            ...
            <Card>{renderRateField('row2Price')}</Card>
            ...
            <Card>{renderRateField('row3Price')}</Card>
          </Grid>
        </Stack>
      </Card>
    </Stack>
