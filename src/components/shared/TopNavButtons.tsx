        ...
        <div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <figcaption className="text-secondary text-[10px] font-body md:text-tagline-2   leading-[150%]">
            ...
            <div className="flex items-center gap-x-3">
              <Link
                ...
                className="shadow-1 bg-background-5 hidden h-8 md:inline-block border-stroke-7 text-accent px-4 py-1 rounded-full cursor-pointer text-center transition-all duration-300 ease-in-out   text-nowrap hover:scale-102">
                <span>Grab it</span>
              </Link>
              <Link
                href="/contact-us-page"
                className="shadow-1 bg-transparent border-stroke-7 h-8 flex items-center justify-center text-secondary border px-4 py-1 rounded-full cursor-pointer text-center transition-all duration-300 ease-in-out   text-nowrap hover:scale-102">
