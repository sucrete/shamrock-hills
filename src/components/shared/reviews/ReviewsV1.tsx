              ...
              <div className="swiper-wrapper">
                {reviews.map((review) => (
                  <SwiperSlide key={review.id} className="swiper-slide">
                    <div
                      className={cn(
                        'bg-background-2 relative z-0 mx-1 flex flex-col gap-y-8 overflow-hidden rounded-[20px] p-8 sm:mx-0',
                        sliderClassName,
                      )}>
                      <GradientOverlay />
                      <figure className="relative inline-block size-14 overflow-hidden rounded-full bg-linear-[156deg,_#FFF_32.92%,_#83E7EE_91%] ring-4 ring-white ">
                        <Image
                          src={review.avatar}
                          height={100}
                          width={100}
                      ...
                      <p className="text-secondary/60 line-clamp-2 review-text">{review.quote}</p>
                      <div>
        ...
        <RevealAnimation delay={0.5}>
          <div className="text-center">
            <LinkButton
              ...
              className={cn(
                'btn btn-md btn-secondary hover:btn-white w-full sm:w-auto',
                btnClassName,
              )}>
              View all reviews
            </LinkButton>
