...
const BlogCardV3 = ({ blog, className }: BlogCardV3Props) => {
  return (
    <article className="group">
      <div
        className={cn(
          'flex scale-100 flex-col items-center rounded-[20px] bg-white transition-transform duration-500 group-hover:scale-[101%] group-hover:transition-transform group-hover:duration-500 md:flex-row xl:gap-x-8 max-h-[308px]',
          className,
        )}>
        {/* blog img */}
        ...
        <div className="px-5 py-4 sm:px-4 xl:px-0 xl:py-8">
          ...
          <div className="mb-7 space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <time dateTime="2025-05-14" className="text-tagline-2 text-secondary/60 ">
                  {blog.publishDate}
                </time>
              </div>
              <div className="text-stroke-2 px-4" aria-hidden="true">
                |
              </div>
              {/* time */}
              <div className="flex items-center gap-2">
                ...
                <span className="text-tagline-2 text-secondary/60 ">{blog.readTime}</span>
              </div>
            </div>
            {/* blog title */}
          ...
          <div>
            <LinkButton
              href={`/blog/${blog.slug}`}
              className="btn btn-white hover:btn-secondary btn-md ">
              Read more
            </LinkButton>
          </div>
        </div>
