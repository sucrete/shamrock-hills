...
const BlogCardV2 = ({ blog, className }: BlogCardV2Props) => {
  return (
    <article className="group col-span-12 lg:col-span-5 xl:col-span-6">
      <div
        className={cn(
          'scale-100 space-y-10 rounded-[20px] bg-white transition-transform duration-500 group-hover:scale-[101%] group-hover:transition-transform group-hover:duration-500',
          className,
        )}>
        {/* link */}
