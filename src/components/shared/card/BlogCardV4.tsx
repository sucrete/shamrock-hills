...
const BlogCardV4 = ({ blog, className }: BlogCardV4Props) => {
  return (
    <div>
      <article
        className={cn(
          'rounded-[20px] overflow-hidden bg-background-2 max-w-[627px] lg:max-w-full lg:mx-0 mx-auto scale-100 hover:scale-[102%] transition-transform duration-500 hover:transition-transform hover:duration-500',
          className,
        )}>
