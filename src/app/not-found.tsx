        ...
        <section className="pt-28 md:pt-36 lg:pt-44 xl:pt-60 pb-20 md:pb-28 lg:pb-40 xl:pb-52 section-reveal">
          <div className="main-container">
            <RevealAnimation delay={0.1}>
              <div className="bg-background-3 rounded-4xl border-[10px] border-white relative overflow-hidden flex flex-col justify-center items-center py-10 md:py-20 lg:py-[100px] text-center pr-2.5">
                ...
                <RevealAnimation delay={0.6} instant>
                  <div>
                    <LinkButton href="/" className="btn btn-lg btn-primary hover:btn-secondary ">
                      Go to Home
                    </LinkButton>
                  </div>
                </RevealAnimation>
